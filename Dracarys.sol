...
contract Dracarys is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0xe47ed62153e0E4f192ad1F06d39d1D4AA3a4EDfE); 
    ...
    uint256 private marketingDivisor = 1;
    
    uint256 public _maxTxAmount = 200000000  * 10**9;
    uint256 private minimumTokensBeforeSwap = 300000  * 10**9; 
